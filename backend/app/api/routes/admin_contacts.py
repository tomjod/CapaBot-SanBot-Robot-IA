...
def _admin_form_state(request: Request, prefix: str = "") -> dict[str, Any]:
...
def _admin_approval_form_state(request: Request, pending_registration_repository: Any | None = None) -> dict[str, Any]:
    query_params = request.query_params
